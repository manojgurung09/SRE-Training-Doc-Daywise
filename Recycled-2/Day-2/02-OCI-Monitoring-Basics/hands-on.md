...
For this lab, we only use **default metrics** from the Compute instance running the BharatMart application.


## 3. Hands-On Task 0 — Understand System Configuration

### Purpose: First, understand what BharatMart application configuration and services are available.
