...
**Scenario:** A new version of BharatMart is deployed, but the application becomes slow after deployment.
...
**Scenario:** Traffic spikes occur during peak shopping periods, requiring system scaling.
