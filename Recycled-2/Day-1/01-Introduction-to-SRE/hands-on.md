...
**Purpose:** See SRE principles in action with the BharatMart training platform.
...
**Why it matters:** This is the application that generates all the metrics, logs, and traces we'll study in SRE training.

### Step 2: View Metrics Endpoint (Demonstrates Observability)

**Purpose:** See how the application exposes metrics for monitoring.
...
**Purpose:** See how the application logs events for troubleshooting.
...
**Purpose:** See how applications expose health status for monitoring.
...
**Purpose:** See metrics update in real-time as the application handles requests.
