...
**Scenario:** BharatMart API is deployed in Availability Domain 1, but the database (OCI Autonomous Database) is in Availability Domain 3.
...
**Scenario:** BharatMart API instances are all placed in the same Fault Domain.
...
**Scenario:** BharatMart API instances are in a private subnet without NAT gateway.
